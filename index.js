...
{
    if(toss==1)
        document.getElementById("strike").value = "AUS Batting";
    else
        document.getElementById("strike").value = "ENG  Batting";
}
var count1=0;
var count2=0;
var w1count=0;
        ...
        else
        {
            ...
            else
            {
                if(team1score>team2score)
                    document.getElementById("result").textContent = "AUS WINS!!!";
                    else if(team2score>team1score)
                    document.getElementById("result").textContent = "ENG WINS!!!";
                else
